...
def render_to_image(image_path, output_path, angle):
    ...
    glRotatef(angle, 0.0, 1.2, 0.2)  # Rotate the object around the Y-axis
...
if __name__ == "__main__":
    ...
    input_image = "RoomEscape//book.png"  # 원본 이미지 경로
    output_image = "RoomEscape//rotated_book.png"  # 저장될 이미지 경로
